namespace GMap.NET.WindowsForms
{
   ...
   public class GMapPolygon : MapRoute, IDisposable
#endif
    {
        ...
        //}
        /// <summary>
        /// for generating random color purpose
        /// </summary>
      ...
      public static readonly Brush DefaultFill = new SolidBrush(Color.AliceBlue);
        ...
        public Color PolyColor
        {
            ...
            {
                _polyColor = value;
                Fill = new SolidBrush(Color.FromArgb(30, value));
        ...
        {
            PolyColor = Color.FromArgb(_random.Next(256), _random.Next(256), _random.Next(256));
        }
