...
{
    public class HorizonHUD : GLControl
    {
        ...
        static HorizonHUD()
        {
            log.Info("Static HorizonHUD ctor");
        }

        public HorizonHUD()
        {
            log.Info("Instance HorizonHUD ctor");
            opengl =
                displayvibe =
                    displayekf =
                        displayheading =
        ...
        public struct Custom
        {
            ...
            {
                get { return Convert.ToDouble(Item.GetValue(src, null)); }
            }
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values"),
         DefaultValue(typeof(Color), "0x9bb824")]
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values"),
         DefaultValue(typeof(Color), "0x414f07")]
        ...
        private Pen _whitePen = new Pen(Color.White, 1);
        ...
        private HorizonHUD graphicsObject;
        private IGraphics graphicsObjectGDIP;

        private DateTime starttime = DateTime.MinValue;

        private System.ComponentModel.ComponentResourceManager resources =
            new System.ComponentModel.ComponentResourceManager(typeof(HorizonHUD));
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (opengl && !DesignMode)
            {
                ...
                {
                    log.Error("HorizonHUD opengl onload 1 ", ex);
                }
                ...
                {
                    log.Error("HorizonHUD opengl onload 2 ", ex);
                }
                ...
                {
                    log.Error("HorizonHUD opengl onload 3 ", ex);
                }
            }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            // Console.WriteLine("HorizonHUD paint");

            // Console.WriteLine("HorizonHUD ms " + (DateTime.Now.Millisecond));
            ...
            lock (this)
            {
                if (inOnPaint)
                {
                    log.Info("Was in onpaint HorizonHUD th:" + System.Threading.Thread.CurrentThread.Name + " in " +
                             otherthread);
                    return;
                }
            ...
            try
            {
                ...
                if (!opengl)
                {
                    ...
                    //File.WriteAllText("HorizonHUD.svg", graphicsObjectGDIP.WriteSVGString());
                }
                else if (opengl)
                {
                    this.SwapBuffers();
            ...
            if (DateTime.Now.Second != countdate.Second)
            {
                ...
                Console.WriteLine("HorizonHUD " + count + " hz drawtime " + (huddrawtime / count) + " gl " + opengl);
        ...
        private readonly Pen _transparentPen = new Pen(Color.Transparent, 2);

        void doPaint()
        {
            //Console.WriteLine("HorizonHUD paint "+DateTime.Now.Millisecond);
            bool isNaN = false;
            try
            {
                ...
                if (displayrollpitch)
                {
                    ...
                    // draws pitch horizontal lines in center
                    //draw pitch           
                    ...
                    // draws numbers above roll arc
                    // draw roll ind needle

                    graphicsObject.TranslateTransform(this.Width / 2, this.Height * 3 / 5);
                    ...
                    pointlist[1] = new Point(-lengthlongex, -lengthlong / 10 - extra);
                    pointlist[2] = new Point(lengthlongex, -lengthlong / 10 - extra);
                    ...
                    // draws red lines and triangle in center
                    // plane wings
                    if (Russian)
                        graphicsObject.RotateTransform(-_roll);
                    ...
                    // graphicsObject.DrawEllipse(_redPen, centercircle);
                    using (Pen redtemp =
                ...
                Rectangle headbg = new Rectangle(0, 0, this.Width - 0, this.Height / 5);
                ...
                if (displayheading)
                {
                    ...
                    for (int a = start; a <= _heading + 60; a += 1)
                    {
                        ...
                        if ((int) a % 15 == 0)
                        {
                            void DrawHeadingCardinalPoints(string cardinalPoint)
                            {
                                drawstring(cardinalPoint, font, fontsize + 4, _whiteBrush,
                                    headbg.Left - 10 + space * (a - start) - fontoffset,
                                    headbg.Bottom - 34 - (int) (fontoffset * 1.7));
                            }
                            ...
                            if (disp == 0)
                            {
                                DrawHeadingCardinalPoints(HUDT.N.PadLeft(2));
                            }
                            else if (disp == 45)
                            {
                                DrawHeadingCardinalPoints(HUDT.NE.PadLeft(2));
                            }
                            else if (disp == 90)
                            {
                                DrawHeadingCardinalPoints(HUDT.E.PadLeft(2));
                            }
                            else if (disp == 135)
                            {
                                DrawHeadingCardinalPoints(HUDT.SE.PadLeft(2));
                            }
                            else if (disp == 180)
                            {
                                DrawHeadingCardinalPoints(HUDT.S.PadLeft(2));
                            }
                            else if (disp == 225)
                            {
                                DrawHeadingCardinalPoints(HUDT.SW.PadLeft(2));
                            }
                            else if (disp == 270)
                            {
                                DrawHeadingCardinalPoints(HUDT.W.PadLeft(2));
                            }
                            else if (disp == 315)
                            {
                                DrawHeadingCardinalPoints(HUDT.NW.PadLeft(2));
                            }
                            else
                            {
                                drawstring(String.Format("{0,3}", (int) (disp % 360)), font, fontsize + 2,
                                    _whiteBrush, headbg.Left - 10 + space * (a - start) - fontoffset,
                                    headbg.Bottom - 32 - (int) (fontoffset * 1.7));
                            }
                        }
                        else if ((int) a % 5 == 0)
                        {
                    ...
                    RectangleF rect = new RectangleF(headbg.Width / 2 - ((fontsize + 7) * 2.4f) / 2, 0,
                        ((fontsize + 7) * 2.4f),
                        headbg.Height);
                    ...
                    {
                        drawstring(String.Format("{0,3}", (int) (heading % 360)), font, fontsize + 5,
                            _whiteBrush, headbg.Width / 2 - ((fontsize + 8) * 1f),
                            headbg.Bottom - 32 - (int) (fontoffset * 1.7));
                    }
                    else
                    {
                ...
                //                Console.WriteLine("HorizonHUD 0 " + (DateTime.Now - starttime).TotalMilliseconds + " " + DateTime.Now.Millisecond);
                ...
                //                Console.WriteLine("HorizonHUD 1 " + (DateTime.Now - starttime).TotalMilliseconds + " " + DateTime.Now.Millisecond);
            ...
            {
                log.Info("HorizonHUD error " + ex.ToString());
            }
        }
