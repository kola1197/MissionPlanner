   ...
   using OpenNETCF.ComponentModel;
    ...
    public partial class GMapControl : UserControl, Interface, IControl
    {
      ...
      protected override void OnResize(EventArgs e)
      {
        ...
        // private void EndAsyncEvent(IAsyncResult asyncResult)
        // {
        //    var ar = (System.Runtime.Remoting.Messaging.AsyncResult) asyncResult;
        ...
        //       Console.WriteLine("Marker async event crashed");
        //    }
        // }
      ...
      public Size DragSize = new Size(4, 4);
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            {
#if !PocketPC
                if (isSelected && !selectionStart.IsEmpty && (Form.ModifierKeys == Keys.Alt ||
                                                              Form.ModifierKeys == Keys.Shift ||
