...
namespace MissionPlanner.GCSViews
{
    partial class FlightPlanner
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.лететьВЭтуТочкуToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.лететьВЭтуТочкуToolStripMenuItem,
            this.зажатьЭтуТочкуToolStripMenuItem,
            this.удалитьToolStripMenuItem,
            this.wPConfigToolStripMenuItem});
            this.contextMenuStrip2.Name = "contextMenuStrip2";
            resources.ApplyResources(this.contextMenuStrip2, "contextMenuStrip2");
            // 
            // лететьВЭтуТочкуToolStripMenuItem
            // 
            this.лететьВЭтуТочкуToolStripMenuItem.Name = "лететьВЭтуТочкуToolStripMenuItem";
            resources.ApplyResources(this.лететьВЭтуТочкуToolStripMenuItem, "лететьВЭтуТочкуToolStripMenuItem");
            // 
        ...
        private ToolStripMenuItem лететьВЭтуТочкуToolStripMenuItem;
