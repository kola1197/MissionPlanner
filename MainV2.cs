...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        private void RefreshForm()
        {
            if (Monitor.TryEnter(locker))
            {
                try
                {
                    ...
                    {
                        instance.Invoke(new Action(() => refreshMainV2ForInvoke()));
                    }
                    ...
                    {
                        timeControl2.timer1.Enabled = true;
                    }
        ...
        private void refreshMainV2ForInvoke() 
        {
            if (comPort.MAV.cs.connected && !CurrentAircraft.ParachuteReleased)
            {
                if (comPort.MAV.cs.ch6out > 1600)
...

        {
            ...
            */
            ...
            initTimersAndSetColors();
        }

        void initTimersAndSetColors()
        {
            if (!timeControl2.timer1.Enabled)
            {
                timeControl2.timer1.Enabled = true;
